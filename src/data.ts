...
export const MOCK_BLOG_POSTS: BlogPost[] = [
  {
    id: "post_1",
    title: "نقش هوش مصنوعی در تحول برنامه‌نویسی تمرینی و ورزشی",
    slug: "ai-in-workout-programming",
    excerpt: "چگونه مدل‌های هوشمند زبانی و الگوریتم‌های آنالیز بدنی، جایگاه ویژه‌ای در مربیگری ورزشی پیدا کرده‌اند و بازدهی ورزشکاران را دوبرابر می‌کنند.",
    content: "امروزه هوش مصنوعی در تمام عرصه‌های زندگی ما نفوذ کرده است و حوزه تناسب اندام و بدنسازی نیز از این قاعده مستثنی نیست. مربیان پیشرو و باشگاه‌های هوشمند اکنون به جای اتکا به روش‌های سنتی و برنامه‌های یکسان برای همه، از موتورهای هوش مصنوعی اختصاصی برای پردازش داده‌های بیومتریک استفاده می‌کنند.\n\nاستفاده از هوش مصنوعی چه مزایایی دارد؟\n۱. شخصی‌سازی فوق‌العاده دقیق بر اساس قد، وزن، درصد چربی و اهداف منحصر به فرد ورزشکار.\n۲. اصلاح پویای برنامه در صورت مواجهه با استپ وزنی یا مصدومیت.\n۳. صرفه‌جویی شدید در زمان مربی برای تمرکز روی نظارت بر اجرای صحیح حرکات.\n\nدر اسمارت جیم، ما با استفاده از پیشرفته‌ترین مدل‌های هوش مصنوعی سرور به مربیان این امکان را می‌دهیم تا در کمتر از چند ثانیه، تخصصی‌ترین و علمی‌ترین برنامه‌های ورزشی و غذایی را متناسب با نیاز ورزشکار تولید کنند.",
    author: "استاد پوریا کریمی",
    category: "فناوری ورزشی",
    imageUrl: "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=600&auto=format&fit=crop",
    publishedDate: "1405/04/10",
    readTime: "۴ دقیقه",
    likes: 24
  },
  {
    id: "post_2",
    title: "اصول مدیریت مدرن باشگاه‌های ورزشی در سال ۲۰۲۶",
    slug: "modern-gym-management-principles",
    excerpt: "بررسی فاکتورهای کلیدی در موفقیت تجاری باشگاه‌ها؛ از مدیریت یکپارچه شعب تا کلوپ‌های وفاداری و اتوماسیون بوفه و انبارداری.",
    content: "دیگر دوران دفاتر کاغذی و هماهنگی‌های تلفنی خسته‌کننده به پایان رسیده است. باشگاه‌های ورزشی امروز به عنوان یک هاب تکنولوژی کوچک عمل می‌کنند که در آن تجربه کاربری حرف اول را می‌زند.\n\nبرای داشتن یک باشگاه فوق‌العاده سودده و محبوب، مدیریت باید بر چند ستون اصلی تمرکز کند:\n- اتوماسیون سیستم حضور و غیاب و تمدیدهای خودکار شهریه.\n- شفافیت مالی بی‌نقص از طریق اتصال مستقیم پلتفرم به درگاه‌های بانکی معتبر کشور نظیر زرین‌پال و سپ.\n- کلوپ وفاداری جذاب برای ایجاد انگیزه و بازگشت مداوم اعضا.\n- بهینه‌سازی بوفه و انبار با سیستم‌های بارکدخوان هوشمند.\n\nبا داشتن یک سیستم جامع و ابری (SaaS)، مدیران باشگاه‌ها حتی بدون حضور فیزیکی می‌توانند تمام جزئیات تراکنش‌ها، موجودی انبار و عملکرد مربیان را کنترل کنند.",
    author: "مهندس یاسین صیادی",
    category: "مدیریت باشگاه",
    imageUrl: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&auto=format&fit=crop",
    publishedDate: "1405/04/05",
    readTime: "۵ دقیقه",
    likes: 42
  },
  {
    id: "post_3",
    title: "تغذیه هوشمند: چگونه رژیم غذایی خود را با اهداف ورزشی همگام کنیم؟",
    slug: "smart-nutrition-gym-goals",
    excerpt: "تعادل درشت مغذی‌ها، هیدراتاسیون و زمان‌بندی طلایی مصرف مواد مغذی برای چربی‌سوزی پایدار و عضله‌سازی بدون چربی.",
    content: "تمرین سخت بدون رژیم غذایی اصولی مانند رانندگی با ترمز دستی کشیده است! برای رسیدن به اهداف تناسب اندام، باید موتور تغذیه خود را بر اساس محاسبات علمی تنظیم کنید.\n\nنکات کلیدی برای موفقیت در تغذیه:\n۱. محاسبه دقیق TDEE (کل انرژی مصرفی روزانه) متناسب با سطح فعالیت.\n۲. دریافت کافی پروتئین (حدود ۱.۶ تا ۲.۲ گرم به ازای هر کیلوگرم وزن بدن) برای ترمیم و بازسازی عضلات.\n۳. زمان‌بندی مناسب وعده قبل و بعد تمرین برای به حداکثر رساندن ریکاوری و انرژی.\n\nابزار هوشمند رژیم‌نویسی پلتفرم اسمارت جیم با در نظر گرفتن سن، جنسیت و تیپ بدنی شما، کالری هدف را مشخص کرده و لیست خریدی کارآمد و دقیق در اختیارتان می‌گذارد تا هیچ فاکتوری از قلم نیفتد.",
    author: "سارا حسینی (متخصص تغذیه)",
    category: "تغذیه و سلامت",
    imageUrl: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=600&auto=format&fit=crop",
    publishedDate: "1405/03/28",
    readTime: "۳ دقیقه",
    likes: 31
  }
];
